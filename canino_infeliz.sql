...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-05-2025 a las 14:16:14
...
(6, 'Ventas', NULL, 1),
(7, 'Categorias', NULL, 1),
(0, 'Mascotas', 'Modulo que gestiona Mascotas y Razas ', NULL),
(0, 'Citas', NULL, NULL),
(0, 'Servicios', NULL, NULL),
(0, 'Productos', NULL, NULL),
(0, 'Inventario', NULL, NULL);
...
--
-- Estructura de tabla para la tabla `razas_mascota`
--
...
--
-- Volcado de datos para la tabla `razas_mascota`
--
...
--
-- Indices de la tabla `razas_mascota`
--
