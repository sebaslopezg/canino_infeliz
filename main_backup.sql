...
(6, 'Ventas', NULL, 1),
(7, 'Categorias', NULL, 1);
INSERT INTO `modulos` (`id_modulo`, `titulo_modulo`, `descripcion_modulo`, `status_modulo`) VALUES (8, 'Mascotas', 'Modulo que gestiona Mascotas y Razas ', NULL), (NULL, 'Citas', NULL, NULL), (NULL, 'Servicios', NULL, NULL);
INSERT INTO `modulos` (`id_modulo`, `titulo_modulo`, `descripcion_modulo`, `status_modulo`) VALUES (9, 'Productos', NULL, NULL), (NULL, 'Inventario', NULL, NULL);
INSERT INTO `modulos` (`id_modulo`, `titulo_modulo`, `descripcion_modulo`, `status_modulo`) VALUES (10, 'Clientes', NULL, NULL);
